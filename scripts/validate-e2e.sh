...
<script>
const layers='${layers[*]}'.split(' '), matrices=[${matrix_specs%,}], sourceWidth=${width}, sourceHeight=${height}, sourceResolution=${RESOLUTION_M}, extentMinX=${extent_min_x}, extentMaxY=${extent_max_y}, sampleUrl='${base}/sample', totalTiles=${tile_count};
